          ...
          <section className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-4 mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Sleeve adds one line: &quot;Peel &amp; Win – check your stick – weekly draw every Friday – icebreaker-win.com&quot;.</li>
              </ul>
            </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <ol className="list-decimal pl-6 space-y-2 text-gray-700">
                ...
                <li>Enter code → instant result:
                  <div className="mt-2 pl-4">
                    <ul className="list-disc pl-6 space-y-1">
                      <li>90 % → 5 % coupon for next box</li>
                      <li>9 % → 100 EGP cash credit</li>
                      <li>1 % → Golden ticket (enters grand draw for phones, TVs, holidays)</li>
                    </ul>
                  </div>
                </li>
                <li>Cash prizes delivered via Vodafone Cash / InstaPay within 24 h.</li>
              </ol>
            </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                <li>Phones / TVs – Samsung, Xiaomi, Carrefour give 20–25 % discount for sleeve impressions + winner un-boxing reels.</li>
                <li>Holidays – TravelStart voucher codes at -15 %.</li>
                <li>100 EGP micro-cash funded from existing 2 EGP per sleeve trade budget → net cost zero.</li>
                <li>Result: we <strong>earn</strong> 300–800 EGP per big-ticket item given away.</li>
              </ul>
            </div>
            ...
            <div className="space-y-4 mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                ...
                <li>Target: 3–5 k live viewers within 6 weeks; clip reels = 20–30 k weekly reach.</li>
              </ul>
            </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-2 text-sm text-gray-800">Submit permit, sign Samsung &amp; Carrefour prize MoUs.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-2 text-sm text-gray-800">National launch + first live draw → PR to Masrawy &amp; Youm7.</td>
                    </tr>
                    <tr>
